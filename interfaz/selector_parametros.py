...
class Dialogo(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(1053, 526)
        self.verticalLayoutWidget_5 = QtWidgets.QWidget(parent=Dialog)
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(20, 440, 201, 71))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(19, 129, 945, 211))
        ...
        self.grid_params_exponencial.addWidget(self.spn_box_media_lambda_expo, 6, 0, 1, 1)
        self.cmb_lambda_media = QtWidgets.QComboBox(parent=self.gridLayoutWidget)
        self.cmb_lambda_media.setObjectName("cmb_lambda_media")
        self.cmb_lambda_media.addItem("")
        self.cmb_lambda_media.addItem("")
        self.grid_params_exponencial.addWidget(self.cmb_lambda_media, 4, 0, 1, 1)
        ...
        self.grid_params_exponencial.addWidget(self.lbl_media_lambda_expo, 5, 0, 1, 1)
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(20, 350, 251, 78))
        ...
        self.layout_v_cant_intervalos.addWidget(self.lbl_cantidad_intervalos)
        self.cmb_cant_intervalos = QtWidgets.QComboBox(parent=self.verticalLayoutWidget_4)
        self.cmb_cant_intervalos.setObjectName("cmb_cant_intervalos")
        self.cmb_cant_intervalos.addItem("")
        self.cmb_cant_intervalos.addItem("")
        self.cmb_cant_intervalos.addItem("")
        self.cmb_cant_intervalos.addItem("")
        self.layout_v_cant_intervalos.addWidget(self.cmb_cant_intervalos)
        ...
        self.layout_h_titulo.addItem(spacerItem)
        ...
        self.layout_h_titulo.addItem(spacerItem1)
        ...
        self.lyt_h_select_distr.addItem(spacerItem2)
        ...
        self.lyt_h_select_distr.addItem(spacerItem3)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cmb_lambda_media.setItemText(0, _translate("Dialog", "Lambda"))
        self.cmb_lambda_media.setItemText(1, _translate("Dialog", "Media"))
        ...
        self.cmb_cant_intervalos.setItemText(0, _translate("Dialog", "10"))
        self.cmb_cant_intervalos.setItemText(1, _translate("Dialog", "15"))
        self.cmb_cant_intervalos.setItemText(2, _translate("Dialog", "20"))
        self.cmb_cant_intervalos.setItemText(3, _translate("Dialog", "25"))
